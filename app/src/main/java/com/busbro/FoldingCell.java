...
import com.busbro.animations.AnimationEndListener;
import com.busbro.animations.FoldAnimation;
import com.busbro.animations.HeightAnimation;
import com.busbro.views.FoldingCellView;
...
public class FoldingCell extends RelativeLayout {
    ...
    // default values
    private final int DEF_ANIMATION_DURATION = 800;
    ...
    public void unfold(boolean skipAnimation) {
        ...
        int part90degreeAnimationDuration = mAnimationDuration / (childCount * 1);
    ...
    protected ArrayList<Integer> calculateHeightsForAnimationParts(int titleViewHeight, int contentViewHeight, int additionalFlipsCount) {
        ...
        int additionalPartsTotalHeight = contentViewHeight - titleViewHeight * 1;
        ...
        if (additionalFlipsCount != 0) {
            Log.d("Cell","titleViewHeight : "+titleViewHeight);

            Log.d("Cell","Flip Counts : "+additionalFlipsCount);
            Log.d("Cell ","additionalPartsTotalHeight : "+additionalPartsTotalHeight);
            ...
            Log.d("Cell ","additionalPartHeight : "+additionalPartHeight);
            Log.d("Cell ","remainingHeight : "+remainingHeight);
